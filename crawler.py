...
QUERY = "user:alibaba" #The personalized query (for instance, to get repositories from user 'rsain')
...
OUTPUT_CSV_FILE = "/Users/zhaopengfei/crawler/repositories.csv" #Path to the CSV file generated as output
